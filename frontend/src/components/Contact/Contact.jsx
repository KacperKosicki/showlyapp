...
const Contact = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            // ✅ Na ten moment frontend jest gotowy.
            // Gdy dodasz endpoint backendowy, podepnij go tutaj.
            // np. fetch(`${process.env.REACT_APP_API_URL}/api/contact`, { ... })
            ...
            <div className={styles.container}>
                <div className={styles.heading}>
                    ...
                    <h2 className={styles.title}>
                        Porozmawiajmy o <span className={styles.titleAccent}>Twoim profilu</span> w Showly
                    </h2>
                            ...
                            <div className={styles.infoList}>
                                <div className={styles.infoRow}>
                                    ...
                                    <div>
                                        ...
                                        <a className={styles.valueLink} href="mailto:kontakt@showly.app">
                                            kontakt@showly.app
                                        </a>
                                    </div>
                                </div>
                                ...
                                <div className={styles.infoRow}>
                                    ...
                                    <div>
                                        <span className={styles.label}>Obszar działania</span>
